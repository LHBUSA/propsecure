...
module.exports = async function handler(req, res) {
  ...
  const lead = {
    ...
    prioritySignal: clean(input.prioritySignal, 180),
    destinationSystem: clean(input.destinationSystem, 240),
  ...
  const fields = [
    ...
    ["Use case", lead.useCase || "General inquiry"],
    ["Priority signal", lead.prioritySignal || "Not provided"],
    ["Destination system", lead.destinationSystem || "Not provided"],
